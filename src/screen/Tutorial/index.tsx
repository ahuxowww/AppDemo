    ...
    <View style={styles.root}>
      ...
      <View style={styles.video}>
        ...
        <View style={styles.play}>
          ...
          >
            <Ionicons
              name={status.isPlaying ? "pause" : "play-sharp"}
              size={40}
              color="#eaeaea"
            />
          </Pressable>
      ...
      <View style={styles.video}>
        ...
        >
          ...
          <AntDesign name="exclamationcircle" size={30} color="#eaeaea" />
        </View>
        <View style={styles.play}>
          <Pressable
            onPress={() =>
      ...
      >
        <Text
          style={{ fontFamily: "Nippo-Light", fontSize: 14, lineHeight: 18 }}
        >
          Download PDF Intruction{" "}
        </Text>
